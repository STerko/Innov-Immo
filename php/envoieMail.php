...
<html lang="fr">
    ...
    <body>
		...
		<?php
			...
			if ( isset($_GET['rgpd'])) {
				$accordRGPD="L'utilisateur a a pris connaissance la loi RGPD" ;
			}
			else {
				$accordRGPD="L'utilisateur n'a pas pris connaissance de la loi RGPD" ;
			}

			
			if ( isset($_GET['norobot'] )) {
				$estRobot="L'utilisateur n'est pas un robot" ;
			}
			else {
				$estRobot="L'utilisateur est un robot" ;
			}
